...
public class VideoFile extends FileType {
    ...
    public VideoFile() {
        super(IFileManagerFileType.VIDEO);
    }

    @Override
    public String accept() {
        return IFileManagerClassify.VIDEO;
    }


    private static final String[] extension=new String[]{"mpeg","mp4","mov","m4v","3gp","3gpp","3g2","3gpp2","avi","divx","divx","asf","flv","mkv","mpg","rmvb","rm"
            ,"vob","f4v","swf"};
    @Override
